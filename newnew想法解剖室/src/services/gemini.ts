...
// For GitHub Pages deployment, you can hardcode your API key below
// 或者在 GitHub Actions 中設定 VITE_GEMINI_API_KEY
const API_KEY = import.meta.env.VITE_GEMINI_API_KEY || "";

if (!API_KEY) {
  console.error("VITE_GEMINI_API_KEY is missing! Please set it in GitHub Secrets.");
}
